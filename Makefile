...
${TARGET}: ${BUILD_DIR}/cadastro.o ${BUILD_DIR}/caixa.o ${BUILD_DIR}/cardapio.o ${BUILD_DIR}/comanda.o ${BUILD_DIR}/conta.o ${BUILD_DIR}/estoque.o ${BUILD_DIR}/main.o
...
${BUILD_DIR}/main.o: ${INCLUDE_DIR}/cadastro.h ${INCLUDE_DIR}/caixa.h ${INCLUDE_DIR}/cardapio.h ${INCLUDE_DIR}/comanda.h ${INCLUDE_DIR}/conta.h ${INCLUDE_DIR}/estoque.h ${PROGRAM_DIR}/main.cpp
